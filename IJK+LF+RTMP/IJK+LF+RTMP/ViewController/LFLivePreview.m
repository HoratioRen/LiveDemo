...
#warning UIInterfaceOrientationPortrait 屏幕方向：竖屏
...
- (UILabel *)stateLabel {
    if (!_stateLabel) {
        _stateLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 40, 80, 40)];
        _stateLabel.text = @"未连接";
...
- (UIButton *)closeButton {
    if (!_closeButton) {
        ...
        _closeButton.yzSize = CGSizeMake(44, 44);
        _closeButton.yzLeft = self.yzWidth - 10 - 44;
        _closeButton.top = 40;
        [_closeButton setImage:[UIImage imageNamed:@"close_preview"] forState:UIControlStateNormal];
        _closeButton.exclusiveTouch = YES;
        
        __weak LFLivePreview * view = self;
        [_closeButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id sender) {
#warning 后加 X号返回
            [[view viewController].navigationController popViewControllerAnimated:YES];
...
- (UIButton *)cameraButton {
    if (!_cameraButton) {
        ...
        _cameraButton.yzOrigin = CGPointMake(_closeButton.yzLeft-10-44, 40);
...
- (UIButton *)beautyButton {
    if (!_beautyButton) {
        ...
        _beautyButton.origin = CGPointMake(_cameraButton.yzLeft - 10 - 44, 40);
...
- (UIButton *)startLiveButton {
    if (!_startLiveButton) {
        ...
        _startLiveButton.size = CGSizeMake(self.yzWidth - 60, 44);
        _startLiveButton.yzLeft = 30;
        _startLiveButton.yzBottom = self.yzHeight - 100;

        _startLiveButton.layer.cornerRadius = _startLiveButton.yzHeight/2;
        ...
        [_startLiveButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id sender) {
            ...
            if (_self.startLiveButton.selected) {
                ...
                stream.url = @"rtmp://live.hkstv.hk.lxdns.com:1935/live/ssr";
